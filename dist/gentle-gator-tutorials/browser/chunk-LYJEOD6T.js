...
function LoginComponent_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1, "Incorrect access code. Please try again.");
    \u0275\u0275elementEnd();
  }
}
var _auth, _router, _route;
var _LoginComponent = class _LoginComponent {
  constructor() {
    __privateAdd(this, _auth);
    __privateAdd(this, _router);
    __privateAdd(this, _route);
    __privateSet(this, _auth, inject(AuthService));
  ...
  submit() {
    if (__privateGet(this, _auth).login(this.password)) {
      const returnUrl = __privateGet(this, _route).snapshot.queryParamMap.get("returnUrl") ?? "/drive-align";
      __privateGet(this, _router).navigateByUrl(returnUrl);
    } else {
      this.error.set(true);
    }
  }
...
_LoginComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], decls: 10, vars: 2, consts: [[1, "login-wrapper"], [1, "login-card"], [1, "subtitle"], ["type", "password", "placeholder", "Access code", "autocomplete", "current-password", 3, "ngModelChange", "keyup.enter", "ngModel"], [3, "click"], [1, "error"]], template: function LoginComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "h1");
    \u0275\u0275text(3, "Gentle Gator Golf");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p", 2);
    \u0275\u0275text(5, "Enter your access code to view tutorials");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(8, "Unlock");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(9, LoginComponent_Conditional_9_Template, 2, 0, "p", 5);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    \u0275\u0275advance(6);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LoginComponent, [{
    type: Component,
    args: [{ selector: "app-login", imports: [FormsModule], template: `
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:css;8f7a7befab3a7349769ddb0aa863fd15697318f69b4cdd8bf5d9ae82a8fe44c5;/home/hoyt/code/tutorial_site_HH/src/app/pages/login/login.component.ts */\n.login-wrapper {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  min-height: calc(100vh - 120px);\n}\n.login-card {\n  background: var(--white);\n  border-radius: var(--border-radius);\n  box-shadow: 0 4px 32px rgba(0, 0, 0, 0.15);\n  padding: 2.5rem;\n  text-align: center;\n  min-width: 320px;\n  max-width: 400px;\n  width: 100%;\n}\nh1 {\n  color: var(--primary-green);\n  margin-bottom: 0.5rem;\n}\n.subtitle {\n  color: #666;\n  margin-bottom: 1.5rem;\n}\ninput[type=password] {\n  width: 100%;\n  padding: 0.6rem 0.75rem;\n  margin-bottom: 1rem;\n  border: 1px solid #ccc;\n  border-radius: var(--border-radius);\n  font-size: 1rem;\n  box-sizing: border-box;\n}\nbutton {\n  width: 100%;\n  padding: 0.65rem;\n  background-color: var(--primary-green);\n  color: var(--white);\n  border: none;\n  border-radius: var(--border-radius);\n  font-size: 1rem;\n  cursor: pointer;\n}\nbutton:hover {\n  background-color: var(--light-green);\n}\n.error {\n  color: #dc3545;\n  margin-top: 0.75rem;\n  font-size: 0.9rem;\n}\n/*# sourceMappingURL=login.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LoginComponent, { className: "LoginComponent", filePath: "src/app/pages/login/login.component.ts", lineNumber: 90 });
})();
export {
  LoginComponent
};
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-LYJEOD6T.js.map
